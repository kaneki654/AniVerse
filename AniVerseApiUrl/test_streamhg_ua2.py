...
async def run():
    ...
    async with httpx.AsyncClient(timeout=15.0, follow_redirects=True) as client:
        ...
        r = await client.get(otakuhg_url, headers={"User-Agent": UA})
        ...
        if match:
            ...
            if m3u8_links:
                ...
                print("With proper UA and otakuhg referer:", resp1.status_code)
                
                resp2 = await client.get(fresh_url, headers={"User-Agent": UA, "Referer": "https://cloudnestra.com/"})
                print("With proper UA and cloudnestra referer:", resp2.status_code)
                
                resp3 = await client.get(fresh_url, headers={"User-Agent": UA})
                print("With NO referer:", resp3.status_code)
