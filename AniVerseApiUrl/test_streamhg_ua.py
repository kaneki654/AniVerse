    ...
    async with httpx.AsyncClient(timeout=15.0, follow_redirects=True) as client:
        ...
        if match:
            ...
            if m3u8_links:
                ...
                print("Testing with proper UA and Referer...")
                resp1 = await client.get(fresh_url, headers={"User-Agent": UA, "Referer": "https://otakuhg.site/"})
                print("With otakuhg referer:", resp1.status_code)
                
                resp2 = await client.get(fresh_url, headers={"User-Agent": UA})
                print("With NO referer:", resp2.status_code)
